 ...
 * Use the {@link FilterScreen#newInstance} factory method to
...
public class FilterScreen extends Fragment {
    ...
    public static FilterScreen newInstance(String param1, String param2) {
        FilterScreen fragment = new FilterScreen();
